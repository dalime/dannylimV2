  ...
  render() {
    ...
    return (
      <Grid container spacing={24}>
        ...
        <Grid item xs={3}>
          <a href='https://dannylim.co/DannyLim_Resume.pdf' rel="noopener noreferrer" target='_blank'><i className={`fa fa-5x fa-file ${width === 'xs' || width === 'sm' ? 'connectBtnSm' : 'connectBtn'}`} width='100%'></i></a>
        </Grid>
        <Grid item xs={3}>
