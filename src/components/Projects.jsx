...
const ProjectsView = ({ isVisible, renderProject, width }) => {
  return (
    <div style={{
      ...
      {renderProject('https://www.behance.net/gallery/84194993/e-Commerce-Site-Redesign', 'https://i.imgur.com/F3eWzM4.gif', 'e-Commerce Store Redesign', 'Sketch App | CSS3 | Magento', `Redesigned a Magento e-Commerce store with views for all devices and translated in Korean with Sketch App. Implementing design in custom Magento theme with HTML and CSS3.`, false)}
      {renderProject('https://sidepackstory.com/', 'https://i.imgur.com/zVpX9HF.gif', 'SidepackStory Travel Blog Website', 'WordPress | Sketch App', `Designed mockups for website after discussing with client with Sketch and implemented website with WordPress`, 'https://www.behance.net/gallery/78524837/SidepackStory-Mockups')}
      {renderProject('https://jstbquiz.herokuapp.com', 'https://i.imgur.com/YNzVDbB.gif', 'JST.B Brand Equity Quiz v2.0', 'React | Node.js | Express | SMTP | Firebase', `Updated an existing web app (A quiz designed to show how well-branded the user's company is) to send an email with a programmatically generated PDF to my client and the quiz taker. Used by prospective clients for JST.B.`, false)}
      ...
      {renderProject('https://bookshare-app.herokuapp.com', 'https://i.imgur.com/KiJgkkn.gif', 'BookShare', 'React | Redux | Node.js | AWS S3 | Stripe API', `Similar to eBay, BookShare is an app to store a library of books that you own, put them up for sale, and buy books from other users.`, 'https://github.com/FigsAndRice/BookShare-App')}
      {renderProject('https://newsrant.herokuapp.com', 'https://i.imgur.com/FHtWxs1.gif', 'NewsRant', 'React | Flux | Firebase | Node.js | iFrames', `A simple app where you can search for news articles, open chatrooms, and talk about them anonymously with other people interested in the same article.`, 'https://github.com/dalime/NewsRant')}
      {renderProject('https://iconoquiz.herokuapp.com', 'https://i.imgur.com/kPoiQLS.gif', 'IconoQuiz', 'React | Flux | CSS | Node.js | Adobe PhotoShop', `A 2-player game that tests the players' knowledge of fast food restaurant logos. Each right answer earns you a point and the first player to five points wins! Challenge your friend.`, 'https://github.com/humanbying/groupProject2')}
