    ...
    <div style={{ position: 'relative' }} className={isVisible ? "sectionView" : "section"}>
      <div className={classes.root} id="experienceRoot">
        ...
        <Typography component="br" />
          ...
          {renderExperience('http://i.imgur.com/zgi7C3A.png', 'https://www.boozallen.com/', 'Booz Allen Hamilton', 'Software Developer (November 2016 - May 2018)', `Booz Allen Hamilton is the largest government contracting firm in the Washington, DC area.
          ...
          {renderExperience('http://i.imgur.com/1GAgpjG.png', 'http://freecodecamp.com', 'Free Code Camp', 'Fullstack Web Development (May 2016 - Current)', `After my internship with a2z, I decided to dedicate more time to better my development skillset.
          ...
          {renderExperience('http://i.imgur.com/SprmAln.png?1', 'http://www.a2zinc.net/show6/public/enter.aspx', 'a2z, Inc.', 'Software Development Intern (September 2015 - May 2016)', `a2z offers robust software solutions for trade show management.
          ...
          {renderExperience('http://i.imgur.com/Fn7p3Gp.jpg', 'http://www2.deloitte.com/us/en.html', 'Deloitte', 'Advisory Consultant (September 2014 - September 2015)', `Deloitte Advisory offers enterprise risk solutions to clients nationwide.
          ...
          {renderExperience('http://i.imgur.com/ErkLYCZ.png', 'http://www.rhsmith.umd.edu/', 'Robert H. Smith School of Business (University of Maryland)', 'Bachelor of Science in Information Systems and Accounting (August 2010 - May 2014)', `From 2010 to 2014, I spent the first defining years of adulthood at UMD.
