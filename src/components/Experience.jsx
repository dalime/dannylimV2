    ...
    <div style={{ position: 'relative' }} className={isVisible ? "sectionView" : "section"}>
      <div className={classes.root} id="experienceRoot">
        ...
        <Typography component="br" />
          ...
          {renderExperience('https://i.imgur.com/9wV1vh8.jpg', false, 'Freelance & Entrepreneurship', 'Frontend Developer & Owner (May 2018 - Current)', `I am currently pursuing some startup ideas while taking on freelance clients, 
          ...
          {renderExperience('https://i.imgur.com/zgi7C3A.png', 'https://www.boozallen.com/', 'Booz Allen Hamilton', 'Software Developer (November 2016 - May 2018)', `Booz Allen Hamilton is the largest government contracting firm in the Washington, DC area.
          ...
          {renderExperience('https://i.imgur.com/1GAgpjG.png', 'https://freecodecamp.com', 'Free Code Camp', 'Fullstack Web Development (May 2016 - Current)', `After my internship with a2z, I decided to dedicate more time to better my development skillset.
          ...
          {renderExperience('https://i.imgur.com/SprmAln.png?1', 'https://www.a2zinc.net/show6/public/enter.aspx', 'a2z, Inc.', 'Software Development Intern (September 2015 - May 2016)', `a2z offers robust software solutions for trade show management.
          ...
          {renderExperience('https://i.imgur.com/Fn7p3Gp.jpg', 'https://www2.deloitte.com/us/en.html', 'Deloitte', 'Advisory Consultant (September 2014 - September 2015)', `Deloitte Advisory offers enterprise risk solutions to clients nationwide.
          ...
          {renderExperience('https://i.imgur.com/ErkLYCZ.png', 'https://www.rhsmith.umd.edu/', 'Robert H. Smith School of Business (University of Maryland)', 'Bachelor of Science in Information Systems and Accounting (August 2010 - May 2014)', `From 2010 to 2014, I spent the first defining years of adulthood at UMD.
        ...
        <Fragment>
          <Grid container spacing={24}>
            <Grid item xs={6} style={{ textAlign: 'right' }}>
              <Avatar className="avatar" src={imgUrl} onClick={url ? () => window.open(url) : () => goToAnchor('connect', false)} style={{ margin: 10, width: 120, height: 120 }}/>
            </Grid>
            <Grid item xs={6} style={{ borderLeft: '1px solid black', textAlign: 'left' }}>
              <Typography gutterBottom variant="inherit" className="companyTitle" onClick={url ? () => window.open(url) : () => goToAnchor('connect', false)}>
                {company}
              </Typography>
              <Typography gutterBottom style={{ fontSize: 14, fontStyle: 'italic' }}>{position}</Typography>
            </Grid>
    ...
    return (
      <Fragment>
        <Grid container spacing={24}>
          ...
          <Grid item xs={12} sm container style={{ borderLeft: '1px solid black' }}>
  ...
  render() {
    ...
    return (
      <TrackVisibility offset={width === 'xs' || width === 'sm' ? 2200 : 1000}>
        {({ isVisible }) => <ExperienceComponent classes={classes} renderExperience={this._renderExperience} isVisible={isVisible} width={width} />}
      </TrackVisibility>
